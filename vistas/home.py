...
def get(path:str):
  with open(path, "r") as p: return json.load(p)
#funcion lottie URL
def get_url(url:str):
  r = requests.get(url) 
...
with st.container(): 
  ...
  st.write("Somos unos apasionados de las tecnologías y la innovación, especializados en el sector de ladigitalización y automatización de negocios. Nos gusta crear soluciones para resolver problemas ymejorar procesos.")
